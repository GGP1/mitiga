// Package executor provides safe command execution for Mitiga.
//
...
// New creates a command executor with the given maximum timeout.
func New(maxTimeout time.Duration) *Executor {
